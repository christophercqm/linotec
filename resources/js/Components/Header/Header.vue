            ...
            >
                ...
                <div class="container-email">
                    <span class="me-3">
                        ...
                        <a
                            href="mailto:contacto@linotec.net"
                            class="text-white text-decoration-none"
                            >contacto@linotec.net</a
                        >
                    </span>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <NavLink class="nav-link" href="/conoce-a-lino"
                                >Conoce a Lino</NavLink
                            >
                        </li>
                        <li class="nav-item">
...
.nav-link.active {
    color: red; /* Color para el enlace activo */
}
